        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">                        
                        <form action="<?php echo site_url('admin/promo/add') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="promo_name">Promo Name</label>
                                <input class="form-control <?php echo form_error('promo_name') ? 'is-invalid':'' ?>"
                                    type="text" name="promo_name" placeholder="Promo Name" />
                            ...
                            <input type="hidden" name="promo_id" value="abc" />
