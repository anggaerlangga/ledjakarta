            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <a href="<?php echo site_url('admin/promo') ?>"><i class="fa fa-arrow-circle-left"></i>Back</a>
                    </div>
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="promo_name">Promo Name</label>
                                <input class="form-control <?php echo form_error('promo_name') ? 'is-invalid':'' ?>"
                                    type="text" name="promo_name" placeholder="Title" value="<?php echo $promo->promo_name ?>" />
                             ...
                             <div class="form-group">
                                ...
                                <textarea class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
                                    rows="4" cols="50" name="description" id="description" value="<?php echo $promo->description ?>"><?php echo $promo->description ?></textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('image') ? 'is-invalid':'' ?>"
                                 ...
                                 <input type="hidden" name="old_image" value="<?php echo $promo->image ?>" />
								<div class="invalid-feedback">
