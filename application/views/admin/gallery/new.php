            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <a href="<?php echo site_url('admin/gallery') ?>"><i class="fa fa-arrow-circle-left"></i>Back</a>
                    </div>
                    <div class="card-body">                        
                        <form action="<?php echo site_url('admin/gallery/add') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="gallery_id" value="abc" />
