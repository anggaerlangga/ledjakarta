    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Section testimoni</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $testimoni->testi_name ?></td>
                                            <td><?php echo $testimoni->description ?></td>
                                            <td>
											    <img src="<?php echo base_url('upload/images/'.$testimoni->image) ?>" width="64" />
										    </td>
                                            <td>
